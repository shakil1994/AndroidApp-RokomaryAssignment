...
public class BookModels {
    ...
    public BookModels(Integer id, String name_bn, String name_en, String summary, String author_name_bn, String publisher_name_bn, Double price, Boolean is_available, Boolean is_unavailable, Boolean is_newarrival, String lang, String image_path, Integer position) {
        this.id = id;
